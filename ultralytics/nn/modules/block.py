...
class EMA(nn.Module):
    ...
    def __init__(self, channels, factor=8):
        super().__init__()
        self.groups = factor
        assert channels // self.groups > 0, "channels must be larger than factor"
...
class C3k2_EMA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True, factor=8):
        super().__init__(c1, c2, n=n, c3k=c3k, e=e, g=g, shortcut=shortcut)
    ...
    def forward(self, x):
        ...
        return self.ema(x)
class C2f_EMA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, factor=8):
        super().__init__(c1, c2, n=n, shortcut=shortcut, g=g, e=e)
        self.ema = EMA(c2, factor=factor)
